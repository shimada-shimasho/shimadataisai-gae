...
router.post('/', (req, res) => {
  ...
  console.log(pos);
  // res.json(pos);
  // storage.bucket('shimada-taisai-dev.appspot.com').putString(pos).then(function(snapshot) {
...
function getPosMap() {
  ...
  // console.log('*** firebase_storage');
  // // Create a reference from a Google Cloud Storage URI
  // var gsReference = storage.refFromURL('gs://shimada-taisai-dev.appspot.com/loc').getDownloadURL().then(function(url) {
  //
  //   console.log(gsReference);
  //   posMap.set(gsReference);
